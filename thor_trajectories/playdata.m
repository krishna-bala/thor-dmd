...
speed = 100;
frame_skip = 1;
% body_id_pos = [];   % (2n)x(max_frames)x(trial) size matrix
                    % n = # agents, HelmetZXSadeq32w43
...
%                 body_id_pos(2*(body_id-1)-1,(t+frame_skip-1)/frame_skip,round_id) = pos(1);
%                 body_id_pos(2*(body_id-1),(t+frame_skip-1)/frame_skip,round_id) = pos(2);
...
% save('body_id_pos.mat', 'body_id_pos')